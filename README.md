...
* 
**État de l'art SSL** : Étude comparative des modèles de tokenisation audio (Wav2Vec, HuBERT) et sélection de l'architecture WavTokenizer.
...
* 
**Entraînement et Inférence** : Configuration et adaptation du modèle WavTokenizer sur des données naturelles malgré les contraintes matérielles liées au nombre d'epochs.
...
Note : Ce projet a été réalisé au sein du laboratoire STMS (IRCAM, CNRS, Sorbonne Université).

---

Souhaitez-vous que je rédige maintenant le README pour votre projet **CamemBERT**, en précisant également votre rôle sur l'entraînement auto-supervisé (Masked Language Modeling) ?
